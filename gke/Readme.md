...
4. Open the Terraform script [GCPGKEFlowLogSetup](https://github.com/manishkumar1991/MonitorYourInfraHealth/blob/main/DataConnectors/GCP/Terraform/sentinel_resources_creation/GCPGKEFlowLogsSetup/GCPGKEFlowLogSetup.tf) and copy its contents
